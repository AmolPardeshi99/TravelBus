...
class BoardingListViewHolder(val view: View, val clickListener: PlacesAdapter.ClickListener): BaseItemViewHolder<BoardingPoint>(view) {
    ...
    override fun setData(data: BoardingPoint) {
        ...
        view.findViewById<ConstraintLayout>(R.id.itemBoarding).setOnClickListener {
            clickListener.boardingItemClicked(data)
        }
    }
}